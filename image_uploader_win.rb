...
# Generated at: Sun Oct 04 13:32:41 +0400 2009
...
class MainWindowBase < Wx::Frame
	...
	attr_reader :m_mainmenu, :m_filemenu, :m_open, :m_quit, :m_options,
              :settings, :m_helpmenu, :m_about, :main_panel,
              :m_notebook2, :m_panel3, :server_static_text,
              :m_choice5, :target_dir, :m_combobox1, :add_server,
              :upload, :m_staticline1, :m_statictext24, :image,
              :browse, :image_panel, :code_explanation, :code,
              :statusbar
	...
	def initialize(parent = nil)
		...
		@main_panel = finder.call("main_panel")
